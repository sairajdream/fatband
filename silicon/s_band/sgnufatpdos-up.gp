...
set output 'Si-s-fatbpdos-up.eps'
set multiplot
...
'Si_s.dat.all' using 1:($2-Efermi):3 title 's' w points pt 7 ps var lt rgb '#8F8300'
...
set xtics ( " " 0)
set noylabel
set key title offset -2.5,-0.2 "Si(s-orb)"
...
##Sx
 p [] []\
 'atom-Si-s.dat' u 3:($1-Efermi) notitle w filledcurve y1=0 lt rgb '#FFF68F',\
 'atom-Si-s.dat' u 3:($1-Efermi) title "s" w l lw 1.0 lt 6 lc rgb '#8F8300'
